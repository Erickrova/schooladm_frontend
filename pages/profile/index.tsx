      ...
      <div>
        ...
        <form className=" mx-4 md:mx-auto md:w-1/2 pb-5 ">
          <div className="flex justify-center flex-col">
            ...
            <input
              type="text"
              value={personalData?.firstName || "Student name"}
              readOnly
          ...
          <div className="flex justify-center flex-col">
            ...
            <input
              type="text"
              value={personalData?.lastName || "Student last names"}
              readOnly
              className="p-2 rounded-full"
          ...
          {profile?.rank == 1 ? (
            <div className="flex justify-center flex-col">
              ...
              <input
                type="text"
                value={personalData?.career?.name || "Student career"}
                readOnly
                className="p-2 rounded-full"
                placeholder="Student career"
              />
            </div>
          ) : null}
          {profile?.rank == 1 ? (
            <div className="flex justify-center flex-col">
              ...
              <input
                type="text"
                value={personalData?.semester || "Student semester"}
                readOnly
                className="p-2 rounded-full"
          ...
          <div className="flex justify-center flex-col">
            ...
            <input
              type="text"
              value={personalData?.documentType || "Student document type"}
              readOnly
              className="p-2 rounded-full"
          ...
          <div className="flex justify-center flex-col">
            ...
            <input
              type="number"
              value={personalData?.documentNumber || 0}
              readOnly
              className="p-2 rounded-full"
          ...
          <div className="flex justify-center flex-col">
            ...
            <input
              type="email"
              value={profile?.email || "Student email"}
              readOnly
              className="p-2 rounded-full"
          ...
          <div className="flex justify-center flex-col">
            ...
            <input
              type="number"
              value={personalData?.contactNumber || 0}
              readOnly
              className="p-2 rounded-full"
          ...
          <div className="flex justify-center flex-col">
            ...
            <input
              type="text"
              value={personalData?.streetAdress || "Student street address"}
              readOnly
              className="p-2 rounded-full"
